export default function RecipeDetailLoading() {
  return (
    <main className="min-h-screen animate-pulse bg-[#fffdf9] text-neutral-950">
      ...
      <section className="mx-auto grid max-w-6xl gap-10 px-6 py-20 lg:grid-cols-[0.78fr_1.22fr]">
        <div className="space-y-5">
          <div className="h-8 w-28 rounded-xl bg-stone-200" />
          <div className="h-52 rounded-[1.5rem] bg-stone-100" />
          <div className="h-48 rounded-[1.5rem] bg-stone-100" />
        </div>
        <div className="space-y-5">
          <div className="h-8 w-40 rounded-xl bg-stone-200" />
          <div className="h-44 rounded-[1.5rem] bg-stone-100" />
          <div className="h-44 rounded-[1.5rem] bg-stone-100" />
        </div>
      </section>
    </main>
