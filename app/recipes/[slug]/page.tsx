            ...
            <div className="mt-9 grid overflow-hidden rounded-[2.25rem] border border-[#ddd2c5] bg-white shadow-[0_24px_75px_rgba(70,50,25,0.08)] lg:grid-cols-[0.92fr_1.08fr]">
              ...
              <div className="flex flex-col justify-center p-8 sm:p-11 lg:p-12">
                <div className="flex flex-wrap items-center gap-3 text-xs font-black tracking-[0.16em]">
                  ...
                  {country && (
                    <span className="rounded-full border border-stone-200 bg-[#fffdf9] px-3 py-1.5 text-[11px] font-black tracking-normal text-neutral-600">
                ...
                {recipe.experienceStatus && (
                  <p className="mt-5 rounded-2xl border border-[#ead8c9] bg-[#fffaf5] px-5 py-4 break-keep text-sm leading-7 text-neutral-600">
                    {recipe.experienceStatus === "researched"
                      ? "현지 식문화 자료를 바탕으로 한국 가정에서 재현하기 쉽게 조정한 레시피입니다."
                      : `콘텐츠 상태: ${experienceStatusLabels[recipe.experienceStatus]}`}
                  </p>
                )}
                ...
                <div className="mt-6 flex flex-wrap items-center gap-3">
                  ...
                  {country?.continent === "europe" && (
                    <Link
                      ...
                      className="inline-flex rounded-full border border-[#d9a487] bg-[#fff7f1] px-4 py-2 text-xs font-black !text-[#943706] no-underline transition hover:border-[#b9480c] hover:bg-[#f8e8dc]"
                    >
                      유럽 여행 기록 →
                    </Link>
                  )}
