              ...
              <div className="flex flex-col justify-center p-8 sm:p-11 lg:p-12">
                ...
                {country?.continent === "europe" && (
                  <Link
                    ...
                    className="mt-7 inline-flex w-fit rounded-full border border-[#d9a487] bg-[#fff7f1] px-5 py-2.5 text-sm font-black !text-[#943706] no-underline transition hover:border-[#b9480c] hover:bg-[#f8e8dc]"
                  >
                    유럽 여행 식탁 기록에서 이어 보기 →
                  </Link>
                )}
